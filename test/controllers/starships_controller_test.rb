...
class StarshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create starship" do
    assert_difference("Starship.count") do
      post starships_url, params: { starship: { crew: @starship.crew, length: @starship.length, manufacturer: @starship.manufacturer, model: @starship.model, name: @starship.name, passengers: @starship.passengers, starship_class: @starship.starship_class } }
    end
  ...
  test "should update starship" do
    patch starship_url(@starship), params: { starship: { crew: @starship.crew, length: @starship.length, manufacturer: @starship.manufacturer, model: @starship.model, name: @starship.name, passengers: @starship.passengers, starship_class: @starship.starship_class } }
