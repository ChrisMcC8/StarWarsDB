...
class PlanetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create planet" do
    assert_difference("Planet.count") do
      post planets_url, params: { planet: { climate: @planet.climate, diameter: @planet.diameter, name: @planet.name, orbital_period: @planet.orbital_period, population: @planet.population, terrain: @planet.terrain } }
    end
  ...
  test "should update planet" do
    patch planet_url(@planet), params: { planet: { climate: @planet.climate, diameter: @planet.diameter, name: @planet.name, orbital_period: @planet.orbital_period, population: @planet.population, terrain: @planet.terrain } }
